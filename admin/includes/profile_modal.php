    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Profil Administrateur</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="password" class="form-control" id="curr_password" name="curr_password" placeholder="Entrez le mot de passe actuel pour enregistrer les modifications" required>
                    </div>
                </div>
          	</div>
